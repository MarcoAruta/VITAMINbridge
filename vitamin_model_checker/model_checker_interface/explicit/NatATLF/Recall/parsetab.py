...
_lr_productions = [
  ...
  ('expression -> expression AND expression','expression',3,'p_expression_binary','regexParser.py',38),
  ('expression -> expression OR expression','expression',3,'p_expression_binary','regexParser.py',39),
  ('expression -> expression IMPLIES expression','expression',3,'p_expression_binary','regexParser.py',40),
  ('expression -> expression CONCAT expression','expression',3,'p_expression_binary','regexParser.py',41),
  ('expression -> expression CHOICE expression','expression',3,'p_expression_binary','regexParser.py',42),
  ('expression -> NOT expression','expression',2,'p_expression_unary','regexParser.py',46),
  ('expression -> expression STAR','expression',2,'p_expression_unary','regexParser.py',47),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','regexParser.py',51),
  ('expression -> PROP','expression',1,'p_expression_prop','regexParser.py',55),
]
